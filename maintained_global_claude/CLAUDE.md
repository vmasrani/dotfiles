...
**A fix verified on this Mac with these tool versions is not verified.** Three consecutive red CI runs (parot-radar #17, 2026-07-24) each came from assuming the local environment was the CI environment:
