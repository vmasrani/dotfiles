...
|-------------------------------------|--------------------------------------|-----------------------|----------------------|
| `./.notes/` in project cwd          | `~/.codex/projects/<proj>/memory/`  | Dendron daily note    | User's task system   |
...
| Travels with the repo (user commits)| Machine-local to `~/.codex`         | Separate vault        | Separate system      |
...
1. Output is always `./.notes/` under cwd, never `~/.codex/...`.
