# Generated by Powerlevel10k configuration wizard on 2023-05-11 at 16:03 EDT.
...
() {
  ...
  # Default context format (no privileges, no SSH): username only.
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%n'

  # Always show context (username).
